...
Join us today and be a hero in someone's life!
        ...
        <div class="col-lg-6" >
          <img class="img-fluid rounded custom-about-image" src="image\human-blood-donate-white-background_1308-110835.jpg" style="position: relative; bottom: 70px;" alt="error">
        </div>
      </div>
    </div>
  </div>
